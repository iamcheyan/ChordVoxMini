...
export function ProviderTabs({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0.5 left-0 rounded-md bg-card border border-border dark:border-border-subtle transition-all duration-200 ease-out pointer-events-none"
